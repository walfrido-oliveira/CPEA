<x-app-layout>
        ...
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            <div class="flex md:flex-row flex-col">
                ...
                <div class="w-full flex justify-end">
                    <div class="m-2 ">
                        <a class="btn-outline-info" href="{{ route('fields.ref.index') }}">{{ __('Listar') }}</a>
                    </div>
                    <div class="m-2">
                        <a class="btn-outline-warning" href="{{ route('fields.ref.edit', ['ref' => $ref->id]) }}">{{ __('Editar') }}</a>
                    </div>
                    <div class="m-2">
                        <button type="button" class="btn-outline-danger delete-ref" id="ref_delete" data-toggle="modal" data-target="#delete_modal" data-id="{{ $ref->id }}">{{ __('Apagar') }}</button>
                    </div>
                </div>
            </div>
                ...
                <div class="mx-4 px-3 py-2 mt-4">
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2">
                            <p class="text-gray-500 font-bold">{{ $ref->id }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2">
                            <p class="text-gray-500 font-bold">{{ $ref->name }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2">
                            <p class="text-gray-500 font-bold">{{ $ref->created_at->format('d/m/Y H:i:s')}}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-1/2">
                            <p class="text-gray-500 font-bold">{{ $ref->updated_at->format('d/m/Y H:i:s')}}</p>
                        </div>
                    </div>
                </div>
    ...
    <x-modal title="{{ __('Excluir usuário') }}"
             ...
             method="DELETE"
             url="{{ route('fields.ref.destroy', ['ref' => $ref->id]) }}"
