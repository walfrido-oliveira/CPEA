<thead>
    <tr class="thead-light">
        ...
        <x-table-sort-header :orderBy="$orderBy" :ascending="$ascending" columnName="field" columnText="{{ __('Matriz') }}"/>
        <th scope="col"
...
<tbody id="ref_table_content">
    @forelse ($refs as $key => $ref)
        <tr>
            <td>
                <input class="form-checkbox ref-url" type="checkbox" name="ref[{{ $ref->id }}]" value="{!! route('fields.ref.destroy', ['ref' => $ref->id]) !!}">
            </td>
            <td>
            ...
            <td>
                ...
                <button class="btn-transition-danger delete-ref" data-url="{!! route('fields.ref.destroy', ['ref' => $ref->id]) !!}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
