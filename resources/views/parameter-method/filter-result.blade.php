...
<tbody id="parameter_method_table_content">
    @forelse ($parameterMethods as $key => $parameterMethod)
        <tr>
            <td>
            ...
            <td>
                ...
                <button class="btn-transition-danger delete-parameter-method" data-url="{!! route('registers.parameter-method.destroy', ['parameter_method' => $parameterMethod->id]) !!}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
