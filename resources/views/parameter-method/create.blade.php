                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-custom-select :options="$parameterAnalysis" name="parameter_analysis_id" id="parameter_analysis_id" :value="old('parameter_analysis_id')" class="mt-1"/>
                        </div>
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label for="analysis_matrix_id" value="{{ __('Matriz') }}" required/>
                            <x-custom-select :options="$analysisMatrix" name="analysis_matrix_id" id="analysis_matrix_id" :value="old('analysis_matrix_id')" class="mt-1"/>
                        </div>
                    </div>
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-custom-select :options="$analysisMethod" name="analysis_method_id" id="analysis_method_id" :value="old('analysis_method_id')" class="mt-1"/>
                        </div>
                    </div>
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label for="time_preparation" value="{{ __('Prazo Preparo') }}" required/>
                            <x-jet-input id="time_preparation" class="form-control block mt-1 w-full" type="number" name="time_preparation" maxlength="255" autofocus autocomplete="time_preparation" :value="old('time_preparation')"/>
                            </div>
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label for="time_analysis" value="{{ __('Prazo Análise') }}" required/>
                            <x-jet-input id="time_analysis" class="form-control block mt-1 w-full" type="number" name="time_analysis" maxlength="255" autofocus autocomplete="time_analysis" :value="old('time_analysis')"/>
                        </div>
                    </div>
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
