                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-jet-input id="analysis_parameter_name" class="form-control block mt-1 w-full" type="text" name="analysis_parameter_name" maxlength="255" autofocus autocomplete="analysis_parameter_name" :value="$parameterAnalysis->analysis_parameter_name"/>
                        </div>
                    </div>
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
