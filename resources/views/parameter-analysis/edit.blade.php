                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-jet-input id="order" class="form-control block mt-1 w-full" type="number" name="order" maxlength="18" autofocus autocomplete="order" :value="$parameterAnalysis->order" />
                        </div>
                    </div>
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-jet-input id="final_validity" class="form-control block mt-1 w-full" type="datetime-local" name="final_validity"  autofocus autocomplete="final_validity" :value="$parameterAnalysis->final_validity ? $parameterAnalysis->final_validity->format('Y-m-d\Th:m') : null"/>
                        </div>
                    </div>
                </div>
            </form>
