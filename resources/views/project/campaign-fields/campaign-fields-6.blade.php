<div class="flex flex-wrap mx-4 px-3 py-2">
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <x-jet-input id="sample_horizon" class="form-control block mt-1 w-full" type="text" name="sample_horizon" maxlength="255" required autofocus autocomplete="sample_horizon" data-type="campaign-fields"/>
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        <x-jet-label for="field_measurements" value="{{ __('Medições realizadas em campo') }}" />
        <x-jet-input id="field_measurements" class="form-control block mt-1 w-full" type="text" name="field_measurements" maxlength="255" required autofocus autocomplete="field_measurements" data-type="campaign-fields"/>
    </div>
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
