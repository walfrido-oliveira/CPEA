                        ...
                        <table id="point_matrix_table" class="table table-responsive md:table w-full">
                            <thead>
                                <tr class="thead-light">
                                    ...
                                    <x-table-sort-header orderBy="created_at" ascending="asc" columnName="point_identifications.area" columnText="{{ __('Área/Ponto') }}" :searchable="true"/>
                                    <x-table-sort-header orderBy="created_at" ascending="asc" columnName="analysis_matrix_id" columnText="{{ __('Matriz') }}" :searchable="true"/>
                                    <x-table-sort-header orderBy="created_at" ascending="asc" columnName="parameter_analysis_groups.name" columnText="{{ __('Grupo Param. Análise') }}" :searchable="true"/>
                                    ...
                                    <x-table-sort-header orderBy="created_at" ascending="asc" columnName="date_collection" columnText="{{ __('DT/HR da Coleta') }}" :searchable="false"/>
                                    <th scope="col"
