                    ...
                    <div id="point_matrix_container"
                        ...
                        <div class="flex flex-wrap mx-4 px-3 py-2">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <x-custom-multi-select multiple :options="$guidingParameters" name="guiding_parameters_id" id="guiding_parameters_id" value="" select-class="form-input" class="mt-1" no-filter="no-filter" default="default"/>
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
