<tr id="point_matrix_row_{{ $key }}" class="point-matrix-row">
    ...
    <td>
        <div class="result inline">
            <a href="{{ route('project.point-matrix.show', ['point_matrix'=> $projectPointMatrix->id]) }}" class="btn-transition text-purple-900" data-row="{{ $key }}" data-type="result" data-id="{{ $id }}">
