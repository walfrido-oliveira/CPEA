<x-app-layout>
            ...
            <form method="POST" action="{{ route('project.campaign.duplicate', ['campaign' => $campaign->id]) }}" id="duplicate_form">
                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    <div class="flex md:flex-row flex-col w-full justify-end">
                        <div class="md:mx-4 md:px-3 py-2  flex justify-end">
                        ...
                        <div class="md:mx-4 md:px-3 py-2 flex justify-end" x-data="{ open: false }">
                            <div class="pr-4 flex">
  ...
  <script>
    function show() {
        var modal = document.getElementById("point_create_alert_modal");
