            ...
            <tr>
                <td class="font-bold" style="background-color:#e1ede1 ">
                    @if ($point->pointIdentification)
                        <button type="button" class="point-open pl-4" data-id="{{ $point->pointIdentification->id }}">{{ $point->pointIdentification->area }} - {{ $point->pointIdentification->identification }}</button>
