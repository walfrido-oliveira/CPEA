<thead>
    <tr class="thead-light">
        ...
        <x-table-sort-header :orderBy="$orderBy" :ascending="$ascending" columnName="area" columnText="{{ __('Campanha') }}"/>
        ...
        <x-table-sort-header :orderBy="$orderBy" :ascending="$ascending" columnName="analysis_matrix_id" columnText="{{ __('DT/HR da Coleta') }}"/>
        <th scope="col"
