    ...
    <div class="py-6 index-environmental-agency">
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            ...
            <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                ...
                <div class="flex mt-4">
                    <table id="environmental_agency_table" class="table table-responsive md:table w-full">
                        @include('environmental-agency.filter-result', ['environmentalAgencys' => $environmentalAgencys, 'ascending' => $ascending, 'orderBy' => $orderBy])
                    </table>
                </div>
                <div class="flex mt-4 p-2" id="pagination">
                    {{ $environmentalAgencys->appends(request()->input())->links() }}
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        window.addEventListener("load", function() {
            var filterCallback = function (event) {
                ...
                ajax.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById("environmental_agency_table").innerHTML = resp.filter_result;
            ...
            function eventsFilterCallback() {
                ...
                document.querySelectorAll("#environmental_agency_table thead [data-name]").forEach(item => {
