                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4" id="samples">
                        <div class="flex w-full">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 flex justify-end align-baseline" style="align-items: baseline;">
                                <button type="button" id="view_table" class="btn-transition-primary px-1" title="Modo de visualização em tabela">
                        ...
                        @if(isset($formValue->values['samples']))
                            ...
                            <div class="flex flex-wrap mt-2 w-full mode-list" style="display: none;">
                                <div class="flex flex-wrap mt-2 w-full">
                                    ...
                                    @for ($i = 0; $i < count($formValue->values['samples']); $i++)
                                        @include('form.sample-list', ['sample' => $formValue->values['samples']["row_$i"]])
                                    @endfor
                                </div>
                            </div>
                        @else
