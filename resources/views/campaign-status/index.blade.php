                ...
                <div class="flex mt-4">
                    <table class="table table-responsive md:table w-full">
                        ...
                        <tbody id="campaign_status_table_content">
                            @include('campaign-status.filter-result', ['campaignStatuses' => $campaignStatuses])
                        </tbody>
                    </table>
                </div>
            ...
            var filterCallback = function (event) {
                ...
                ajax.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById("campaign_status_table_content").innerHTML = resp.filter_result;
