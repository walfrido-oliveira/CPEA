    ...
    <div class="py-6 index-geodetics">
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            ...
            <div class="px-2 my-2 bg-white rounded-lg min-h-screen">
                ...
                <div class="flex mt-4">
                    <table id="geodetics_table" class="table table-responsive md:table w-full">
                        @include('geodetics.filter-result', ['geodetics' => $geodetics, 'ascending' => $ascending, 'orderBy' => $orderBy])
                    </table>
                </div>
    ...
    <script>
        window.addEventListener("load", function() {
            var filterCallback = function (event) {
                ...
                ajax.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById("geodetics_table").innerHTML = resp.filter_result;
            ...
            function eventsFilterCallback() {
                ...
                document.querySelectorAll("#geodetics_table thead [data-name]").forEach(item => {
