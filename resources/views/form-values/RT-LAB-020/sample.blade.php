                ...
                <table class="table">
                    ...
                    <tbody id="table_result">
                        @foreach (array_chunk($sample['results'], 3)[0] as $key => $value)
                            @include('form-values.RT-LAB-020.sample-fields', ['key' => $key, 'value' => $value])
                        @endforeach
                    </tbody>
                    <tfoot id="table_result_footer">
                        @include('form-values.RT-LAB-020.sample-footer')
                    </tfoot>
                </table>
            </div>
            @include('form-values.RT-LAB-020.sample-duplicate-footer')
        </div>
    @endif
</div>
