<x-app-layout>
    <div class="py-6 create-preparation-method">
        <div class="md:max-w-6xl lg:max-w-full mx-auto px-4">
            <form method="POST" action="{{ route('registers.preparation-method.store') }}">
                @csrf
                @method("POST")
                <div class="flex md:flex-row flex-col">
                    ...
                    <div class="w-full flex justify-end">
                        ...
                        <div class="m-2">
                            <a href="{{ route('registers.preparation-method.index')}}" class="btn-outline-danger">{{ __('Cancelar') }}</a>
                        </div>
                    </div>
                </div>
