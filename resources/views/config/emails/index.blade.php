                ...
                <div class="py-2 my-2 bg-white rounded-lg min-h-screen">
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label :value="__('Nome do Remetente')" for="mail_from_name"/>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label :value="__('E-mail')" for="mail_from_adress"/>
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label :value="__('Host')" for="mail_host"/>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label :value="__('Porta')" for="mail_port"/>
                    ...
                    <div class="flex flex-wrap mx-4 px-3 py-2 mt-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label :value="__('Usuário')" for="mail_user_name"/>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-jet-label :value="__('Senha')" for="mail_password"/>
